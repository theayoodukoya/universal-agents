...
# SECURITY: S3 Bucket for Terraform State with Security Hardening
...
# SECURITY: Store DB password in AWS Secrets Manager
resource "aws_secretsmanager_secret" "db_password" {
  name = "rds/${var.environment}/db-password"
...
resource "aws_db_instance" "main" {
  ...
  # SECURITY: Use AWS Secrets Manager to manage database password instead of passing directly.
